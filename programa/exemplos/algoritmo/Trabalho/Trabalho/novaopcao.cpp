...
void inserirFim(Lista *lista, string nome, string cpf, string data, int dose, string vacina)
{
    ...
    if (lista->inicio == NULL)
    {
        ...
        } while (vacina != "a" && vacina != "A" && vacina != "p" && vacina != "P" && vacina != "c" && vacina != "C" && vacina != "j" && vacina != "J");
...
void mostrarTudo(Lista *lista)
{
    ...
    while (inicio != NULL)
    {
        ...
        cout << "\n";
        cout << "Tipo da vacina: ";
        if (inicio->vacina == "A" || inicio->vacina == "a")
        {
            cout << "Astrazeneca";
        }
        else if (inicio->vacina == "P" || inicio->vacina == "p")
        {
            cout << "Pfizer";
        }
        else if (inicio->vacina == "C" || inicio->vacina == "c")
        {
            cout << "Coronavac";
        }
        else if (inicio->vacina == "J" || inicio->vacina == "j")
        {
            cout << "Jansen";
        }
        cout << "\n\n";
